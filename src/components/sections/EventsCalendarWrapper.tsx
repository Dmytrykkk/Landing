...
function SectionSkeleton({ className = "" }: { className?: string }) {
  return (
    <section className={`py-12 sm:py-16 lg:py-20 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 ${className}`} aria-hidden>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="animate-pulse">
            <div className="h-10 bg-gray-300 dark:bg-gray-700 rounded w-1/3 mb-8" />
