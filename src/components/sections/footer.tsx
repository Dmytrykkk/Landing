    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <section>
            <h3 className="text-white text-xl font-bold mb-4">ФКНФМ ХДУ</h3>
          ...
          <address className="not-italic">
            <h4 className="text-white font-semibold mb-4">Приймальна комісія</h4>
            <ul className="space-y-2 text-sm text-gray-300" role="list">
              <li role="listitem">
                <a
                  href="mailto:priyom@kspu.edu.ua"
                  className="hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 rounded transition-colors"
                >
              ...
              <li role="listitem" className="mt-4">
                <strong className="text-white">Адреса:</strong>
                <br />
                м. Івано-Франківськ
                <br />
                вул. Шевченка, 57
