  ...
  const features = [
    {
      ...
      description:
        "Гнучке поєднання синхронних онлайн-занять та асинхронного навчання, що дозволяє навчатися в зручний для вас час",
    },
    {
      title: "Асинхронні матеріали",
      description:
        "Доступ до відеолекцій, презентацій, практичних завдань та додаткових ресурсів 24/7 для самостійного вивчення",
    },
    {
      title: "Підтримка доступності",
      description:
        "Субтитри до відео, текстові версії матеріалів, адаптивний інтерфейс та технічна підтримка для студентів з особливими потребами",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 sm:space-y-8" role="list">
          {features.map((feature, index) => (
            <article
              key={index}
              className="bg-gray-50 dark:bg-gray-800 p-6 sm:p-8 rounded-lg focus-within:ring-2 focus-within:ring-[#3b82f6] focus-within:ring-offset-2 dark:focus-within:ring-offset-gray-900"
              role="listitem"
            >
